...
export default class App extends React.Component {
  ...
  render() {
    return (
      <FormGroup>
        <h4 class="text-center">My Blog Spot</h4>
        <Form class="mx-auto" onSubmit={this.handleSubmit}>
          {this.state.id && (
            <>
              <FormGroup>
                <label>Post ID : </label>
            ...
            <br />
            <div class="mx-auto">
            <label style={{display: 'margin-right:10px'}}><b>UserName:</b> </label> 
          ...
          <br />
          <Link color="primary" to ="/">Go back</Link>
          <br/>
          <br/>
          <FormGroup >
